...
```{r byyear, eval=TRUE, echo=TRUE, message=FALSE}
#I add the geom. 
...
```{r}
#I tried to generate the histograms for C1, C2, and C3 for 2013 and 2023 data, but could not. There, I'm exporting my file as a RDS and CVS and showing the code I tried below.
...
```{r facets_free_histo, eval=TRUE, echo=FALSE, message=FALSE}
#I tried again, just using 2013 data, this also did not work.
